...
const DropdownDirectionTopMixin = css<{valueContainerHeight: number; top: number, innerHeight: number}>`
  bottom: ${({ valueContainerHeight, top, innerHeight }) => innerHeight - top - valueContainerHeight / 2}px;
