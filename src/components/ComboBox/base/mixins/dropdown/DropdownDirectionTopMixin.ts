...
const DropdownDirectionTopMixin = css<{valueContainerHeight: number; top: number}>`
  bottom: ${({ valueContainerHeight, top }) => window.innerHeight - top - valueContainerHeight / 2}px;
